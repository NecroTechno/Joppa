    ...
    match validate {
        Ok(form) => {
            ...
            match result {
                ...
                Err(error_result) => {
                    let context = &contexts::ValidateContextFail { title: "Joppa", error_result: error_result };
        ...
        Err(None) => {
            let context = &contexts::ErrorContext { title: "Joppa" };
...
#[get("/")]
fn index() -> Template {
    let context = &contexts::IndexContext { title: "Joppa" };
